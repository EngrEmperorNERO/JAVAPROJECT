...
public interface PaymentRepository extends CrudRepository<Payment, Integer> {
    ...
    void makePayment(@Param("account_id") int account_id,
                     ...
                     @Param("beneficiary_acc_no") String beneficiary_acc_no,  //change to string this if theres an error
    ...
    //UPDATE MONEY OF USER IN THE DATABASE
    @Modifying
    @Query(value="INSERT INTO accounts(balance)"+
    		"VALUES(:balance)",nativeQuery =true)
    @Transactional
    void addMoney(@Param("balance")double balance );
