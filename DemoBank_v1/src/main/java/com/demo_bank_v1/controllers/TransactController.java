...
public class TransactController {
    ...
    public String payment(@RequestParam("beneficiary")String beneficiary,
        ...
        //NEWLY ADDED FOR PAYMENT IN RECIPIENT
        //newly added variables for account number
        int accountnumber = Integer.parseInt(account_number);
       
        //paymentRepository.addMoney(newBalance);
        //TODO: UPDATE ACCOUNT TO RECIPIENT:    
        double currentBalance2 = accountRepository.getAccountBalance2(accountnumber);
        newBalance = currentBalance2 + paymentAmount;
        accountRepository.changeAccountBalanceByAccountNumber(newBalance, accountnumber);    
        //end of newly added features for updating user account number balance
        ...
        redirectAttributes.addFlashAttribute("success", successMessage);
        return "redirect:/app/dashboard";     
        //TO DO: UPDATE RECORDS OF THE BENEFICIARY
        //IF IN THE DATABASE IT WILL UPDATE, IF NOT AS IT IS FIRST
        //int userAcountNum = Integer.parseInt(account_number);
       // if(userAcountNum ==) {       	
        //}    
    }
